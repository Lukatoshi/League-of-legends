window.addEventListener('load', () => {
  ...
  videoSource.src = '/Ornn/src/assets/Ornn_mp4.mp4'; // Substitua pelo seu caminho de vídeo
  videoSource.type = 'video/mp4';
  video.appendChild(videoSource);
  videoContainer.appendChild(video);

  // Criação do áudio (MP3)
  const audio = new Audio('/Ornn/src/assets/Ornn_mp3.mp3'); // Caminho para o áudio MP3
  audio.autoplay = true; // Inicia automaticamente o áudio
  audio.play(); // Começa a reprodução do áudio
